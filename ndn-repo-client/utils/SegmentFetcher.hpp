...
public:
   ...
   */
  ndn::util::signal::Signal<SegmentFetcher, ConstBufferPtr> onComplete;
   ...
   */
  ndn::util::signal::Signal<SegmentFetcher, uint32_t, std::string> onError;

  /**
   * @brief Emitted whenever a data segment received.
   */
  ndn::util::signal::Signal<SegmentFetcher, Data> afterSegmentReceived;

  /**
   * @brief Emitted whenever a received data segment has been successfully validated.
   */
  ndn::util::signal::Signal<SegmentFetcher, Data> afterSegmentValidated;

  /**
   * @brief Emitted whenever an Interest for a data segment is nacked.
   */
  ndn::util::signal::Signal<SegmentFetcher> afterSegmentNacked;

  /**
   * @brief Emitted whenever an Interest for a data segment times out.
   */
  ndn::util::signal::Signal<SegmentFetcher> afterSegmentTimedOut;
   ...
   */
  ndn::util::signal::Signal<SegmentFetcher, ConstBufferPtr> onInOrderData;

  /**
   * @brief Emitted on successful retrieval of all segments in 'in order' mode.
   * @note Emitted only if SegmentFetcher is operating in 'in order' mode.
   */
  ndn::util::signal::Signal<SegmentFetcher> onInOrderComplete;
